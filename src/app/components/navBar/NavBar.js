        ...
        <section id="navBar" className={`flex center ${navBarStyle}`}>
            <div className="navBar flex center align-center">
                <div className="hero-cta load-hidden navLink flex center align-center">
                    ...
                    <a rel="noreferrer" href="https://www.linkedin.com/in/elia-kopff-16064b228/?original_referer=https%3A%2F%2Fwww%2Egoogle%2Ecom%2F&originalSubdomain=fr" target="_blank" className={`animated-button ${darkMode ? "dark-mode" : ""}${buttonStyle}`}>
